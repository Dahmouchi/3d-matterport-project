          ...
          >
            <div className="aspect-[16/9] relative">
              ...
              <div className="absolute bottom-2 px-4 w-full">
                <div className="flex w-full   px-8  justify-center items-center  mt-2 sm:mt-3 md:mt-4 bg-[#fff] rounded-full text-center pl-4 sm:pl-5 md:pl-6 pr-1 sm:pr-2 py-2 gap-4 sm:gap-6 md:gap-8">
                  <img
