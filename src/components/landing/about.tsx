  ...
  const steps = [
    {
      ...
      title: "Découverte",
      text:
        "Nous analysons vos besoins, votre audience et vos objectifs pour cadrer une vision claire et mesurable.",
      icon: Search,
    },
    {
      number: "2",
      title: "Conception",
      text:
        "Design de l'expérience, scénarisation et prototypage. Nous choisissons les meilleurs outils et parcours.",
      icon: Sparkles,
    },
    {
      number: "3",
      title: "Production",
      text:
        "Captation 3D, intégrations (Matterport/BIM), contenus interactifs et automatisations prêtes à scaler.",
      icon: Box,
    },
    {
      number: "4",
      ...
      text:
        "Formation, analytics et itérations continues pour des résultats durables et un ROI tangible.",
      icon: Handshake,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <p className="mt-4 text-slate-50 leading-relaxed">
            Nous combinons design, 3D et technologie pour créer des expériences immersives à fort impact. Voici comment nous travaillons pour transformer vos idées en résultats concrets.
          </p>
              ...
              <div className="group h-full rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 transition hover:-translate-y-0.5 hover:bg-white/[0.07] hover:shadow-lg hover:shadow-indigo-950/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-white leading-relaxed">{step.text}</p>
                  </div>
                </div>
              </div>
            </motion.li>
