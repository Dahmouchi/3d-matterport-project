...
const HeroSection1 = ({ dict, rtl }: { dict: HeroDict; rtl: boolean }) => {
  const words = dict.typewriter.map((text, i) => ({
    text,
    ...(i === dict.typewriter.length - 1
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 overflow-hidden">
      ...
      >
        <div
          className={`col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-2 flex flex-col justify-center max-w-none sm:max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl ${rtl ? "lg:pr-16 md:pr-8 sm:pr-4" : "lg:pl-16 md:pl-8 sm:pl-4"} p-2 mt-6 gap-2 sm:gap-3 md:gap-4 lg:gap-4`}
        >
          <div className="text-center sm:text-center md:text-left lg:text-left">
            <div className="flex justify-center sm:justify-center md:justify-start lg:justify-start">
              <TypewriterEffectSmooth
                words={words}
                className="text-2xl sm:text-2xl md:text-4xl lg:text-4xl xl:text-5xl font-bold font-montserrat uppercase"
              />
            </div>
          ...
          <h2
            className={`text-base sm:text-lg md:text-xl lg:text-xl xl:text-xl text-slate-50 text-center sm:text-center ${rtl ? "md:text-right lg:text-right" : "md:text-left lg:text-left"} font-poppins px-2 sm:px-0`}
          >
            {dict.subtitle}
          </h2>
        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1 bg-gradient-to-r from-[#f6ba13] to-orange-400 p-4 sm:p-6 md:p-8 shadow-lg flex flex-col justify-center h-full relative">
          ...
          <motion.img
            ...
            src="/images/steps/visite_virtuelle_maroc.png"
            alt="logo"
