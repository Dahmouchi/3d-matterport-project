  ...
  return (
    <>
      ...
      <motion.button
        ...
        onClick={() => setOpen((v) => !v)}
        className="fixed right-4 top-4 z-[60] rounded-full bg-gradient-to-r from-[#f6ba13] to-orange-400 text-white shadow-xl p-3"
      ...
      <motion.nav
        ...
        className="fixed top-3 left-1/2 -translate-x-1/2 rounded-full lg:px-4 px-2 z-40 border-b-2 border-t-gray-200 border-t border-[#f6ba13] bg-white shadow w-11/12"
      >
        <div className="mx-auto flex w-full items-center justify-between px-6 py-4 gap-12">
          ...
          <Link href="#contact" className="hidden md:flex items-center gap-2">
            <div className="text-white font-semibold rounded-full bg-gradient-to-r from-[#f6ba13] to-orange-400 px-4 py-2">
              Prendre RDV
            </div>
            <div className="rounded-full bg-gradient-to-r from-[#f6ba13] to-orange-400 text-white p-2">
              <Phone />
            </div>
          </Link>
